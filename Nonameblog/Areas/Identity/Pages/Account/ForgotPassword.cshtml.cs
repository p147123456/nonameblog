    ...
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                sendMail.Mail_SendAsync(new string[] { Input.Email }, "Reset your password", $"Click the link to reset your password <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
